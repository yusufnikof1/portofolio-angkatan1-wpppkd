...
if (isset($_POST['kirim'])) {
    ...
    $cekEmail = mysqli_query($con, "SELECT email FROM contact WHERE email = '$email'");
    ...
    if ($rowEmail) {
        ...
        $insert = mysqli_query($con, "INSERT INTO contact (nama, email, subjek, pesan) VALUES ('$nama','$email','$subjek','$pesan')");
        if ($insert) {
...
$selectResume = mysqli_query($con, "SELECT * FROM resume");
$rowResumes = mysqli_fetch_all($selectResume, MYSQLI_ASSOC);
// var_dump($rowResumes);

$selectSkill = mysqli_query($con, "SELECT * FROM skill");
$rowSkills = mysqli_fetch_all($selectSkill, MYSQLI_ASSOC);
// var_dump($rowSkills);
                ...
                <div class="col-md-6 col-lg-5 d-flex">
                    <div class="img-about img d-flex align-items-stretch">
                        ...
                        <div class="img d-flex align-self-stretch align-items-center">
                            <img src="assets/uploads/<?php echo $rowAbout['logo'] ?>" alt="" class="img d-flex align-self-stretch align-items-center">
                        </div>
                    </div>
                </div>
                ...
                ?>
                    <div class="col-md-6 animate-box">
                        <div class="progress-wrap ftco-animate">
                            <h3><?php echo $value['nama_skill']; ?></h3>
                            <div class="progress">
                                <div class="progress-bar color-1" role="progressbar" aria-valuenow="<?php echo $value['persentase'] ?>"
                                    aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $value['persentase'] ?>%">
                                    <span><?php echo $value['persentase'] . "%" ?></span>
                                </div>
                            </div>
            ...
            <div class="row no-gutters block-9">
                <div class="col-md-6 order-md-last d-flex">
                    <form action="" method="POST" class="bg-light p-4 p-md-5 contact-form">
                        ...
                        <div class="form-group">
                            <textarea name="pesan" cols="30" rows="7" class="form-control" required placeholder="Message"></textarea>
                        </div>
                        <div class="form-group">
                            <input name="kirim" type="submit" value="Send Message" class="btn btn-primary py-3 px-5">
                        </div>
                    </form>
